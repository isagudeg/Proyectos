...
/////////////////////////////////////////////////////////////////////////////////////////////////
unsigned int InsertarHash(TablaHash *t, TIPOELEMENTO elemento, unsigned int tipoFH, unsigned int K) {
...
//////////////////////////////////////////////////////////////////
int BuscarHash(TablaHash t, char *clavebuscar, TIPOELEMENTO *e, unsigned int tipoFH, unsigned int K, unsigned int *nPasosExtraB) {
    TPOSICION p;
...
///////////////////////////////////////////////
int EsMiembroHash(TablaHash t, char *clavebuscar, unsigned int tipoFH, unsigned int K, unsigned int *nPasosExtraB) {
    TPOSICION p;
    int encontrado = 0;
...
///////////////////////////////////////////////
void BorrarHash(TablaHash *t, char *claveborrar, unsigned int tipoFH, unsigned int K, unsigned int *nPasosExtraE) {
    TPOSICION p;
    TIPOELEMENTO elemento;
