...
void insercionArchivo(FILE *fp, TablaHash t, unsigned int tipoFH, unsigned int K, unsigned int tipoR, unsigned int a, unsigned int *nColisionesI, unsigned int *nPasosExtraI);
void busquedaArchivo(FILE *fp, TablaHash t, unsigned int tipoFH, unsigned int K, unsigned int tipoR, unsigned int a, unsigned int *nPasosExtraB);
...
int main(int argc, char** argv) {
    ...
    unsigned int nColisionesI=0, nPasosExtraI=0, nPasosExtraB=0;
...
void insercionArchivo(FILE *fp, TablaHash t, unsigned int tipoFH, unsigned int K, unsigned int tipoR, unsigned int a, unsigned int *nColisionesI, unsigned int *nPasosExtraI) {
    ...
    if (fp) {
        ...
        while (!feof(fp)) {
            ...
            /////////////////////////////////////////////////////////////////////////////////////////
            *nColisionesI = *nColisionesI + InsertarHash(t, jugador, tipoFH, K, tipoR, a, nPasosExtraI);
            fscanf(fp, "%[^-] - %s - %s", jugador.nombre, jugador.alias, jugador.correo);
        }
    } else {
